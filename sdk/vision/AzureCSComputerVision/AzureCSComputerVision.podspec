...
Pod::Spec.new do |spec|
  spec.name         = "AzureCSComputerVision"
  spec.version      = "1.0.0-beta.1"
  spec.summary      = "Client library for Azure Cognitive Services Computer Vision service."
  spec.description  = <<-DESC
  Client library for Azure Cognitive Services Computer Vision service.
                   DESC
