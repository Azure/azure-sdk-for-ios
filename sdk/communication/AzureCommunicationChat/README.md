...
// swift-tools-version:5.3
    dependencies: [
        ...
        .package(name: "AzureCommunicationChat", url: "https://github.com/Azure/SwiftPM-AzureCommunicationChat.git", from: "1.1.0-beta.1")
    ],
```
...
target 'MyTarget' do
  pod 'AzureCommunicationChat', '1.1.0-beta.1'
  ...
end
```
