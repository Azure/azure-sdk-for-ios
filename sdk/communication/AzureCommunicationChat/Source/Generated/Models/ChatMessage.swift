...
public struct ChatMessage: Codable {
    ...
    public init(
        id: String, type: ChatMessageType, priority: ChatMessagePriority, sequenceId: String, version: String,
        content: ChatMessageContent? = nil, senderDisplayName: String? = nil, createdOn: Iso8601Date,
        senderId: String, deletedOn: Iso8601Date? = nil, editedOn: Iso8601Date? = nil
    ) {
        self.id = id
        self.type = type
