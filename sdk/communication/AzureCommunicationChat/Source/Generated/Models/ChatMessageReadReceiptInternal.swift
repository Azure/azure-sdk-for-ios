...
public struct ChatMessageReadReceiptInternal: Codable {
    // MARK: Properties
    ...
    public init(
        senderCommunicationIdentifier: CommunicationIdentifierModel, chatMessageId: String, readOn: Iso8601Date
    ) {
