...
The latest version of the SDK is [1.0.0-beta.10](https://github.com/Azure/azure-sdk-for-ios/releases/tag/1.0.0-beta.10). Older [releases](https://github.com/Azure/azure-sdk-for-ios/releases) are also available.
...
```swift
    dependencies: [
        ...
        .package(url: "https://github.com/Azure/azure-sdk-for-ios.git", from: "1.0.0-beta.10")
    ],
```
...
target 'MyTarget' do
  pod 'AzureCommunicationChat', '~> 1.0.0-beta.10'
  ...
end
```
