...
@objc public class UrlHttpResponse: HttpResponse {
    ...
    @objc public init(request: HttpRequest, response: HTTPURLResponse?, blockSize: NSNumber = 4096, delegate: HttpResponseDelegate? = nil) {
        self.internalResponse = response
        super.init(request: request, blockSize: blockSize, delegate: delegate)
